...
adapted_from: 'https://github.com/chainlight-io/publications/tree/417d1475d3b7057db6e0da2cbaba6104576f3d20/ctf-writeups/curta-cup/Submerged'
---
...
After this, it's as simple as calling the `proveSubmergedSeed` function and passing in the raw transaction bytes.
