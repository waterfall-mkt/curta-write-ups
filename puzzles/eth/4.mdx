...
First, to address the name of the puzzle, it is a play on words that is meant to sound similar to “water buckets”. The water buckets puzzle is a classical logic puzzle around which I based this CTF puzzle.
